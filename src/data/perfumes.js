export const perfumes = [
  {
    ...
    image: "https://fimgs.net/mdimg/perfume/375x500.1816.jpg"
  },
  {
    id: "aventus",
    name: "Aventus",
  ...
  },
  {
    ...
    accords: [
      { name: "Fresh Spicy", val: 95 },
      { name: "Amber", val: 90 },
      { name: "Citrus", val: 85 },
      { name: "Aromatic", val: 80 }
    ],
    pyramid: {
  ...
  },
  {
    ...
    year: 2009,
    description: "A story of intensity, bold sensuality, and seduction that lies half-way between restraint and abandon. Bright, masculine freshness combines with sophistication and nonchalance.",
    accords: [
      { name: "Aromatic", val: 95 },
      { name: "Warm Spicy", val: 90 },
      { name: "Woody", val: 85 },
      { name: "Floral", val: 70 }
    ],
  ...
  },
  {
    ...
    image: "https://fimgs.net/mdimg/perfume/375x500.9023.jpg"
  },
  {
    id: "eros",
    name: "Eros",
    brand: "Versace",
    year: 2012,
    description: "Love, passion, beauty, and desire. These are the key concepts of the men's fragrance by Versace. The perfection of the male body is fused with the allusion to Greek mythology.",
    accords: [
      { name: "Vanilla", val: 95 },
      { name: "Aromatic", val: 90 },
      { name: "Green", val: 85 },
      { name: "Fresh Spicy", val: 80 }
    ],
    pyramid: {
  ...
  },
  {
    ...
    year: 2015,
    description: "An elegant, airy and deep fragrance. The fragrance symbolizes the merging of sea waves with black rocks. Acqua di Giò Profumo is an aquatic, aromatic, woody and spicy composition.",
    accords: [
      { name: "Aromatic", val: 95 },
      { name: "Marine", val: 90 },
      { name: "Fresh Spicy", val: 85 },
      { name: "Woody", val: 80 }
    ],
    pyramid: {
